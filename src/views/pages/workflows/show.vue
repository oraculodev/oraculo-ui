...
export default {
  ...
  methods: {
    getData() {
      ...
      this.loading = true
      this.$store
        .dispatch('workflows/getById', { id: workflowId })
        .then(({ data }) => {
          this.data = data
          this.loading = false
          console.log(data)
    ...
    getEditUrl() {
      return `${process.env.VUE_APP_ORACULO_ADMIN_URL}/catalog/workflow/${this.data.id}/change/`
    },
  },
}
</script>
      ...
      <div class="col-xl-7">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                <h5 class="text-uppercase font-size-14">Descrição</h5>
            ...
            <div class="row mt-3">
              <div class="col-lg-6">
                <h5 class="text-uppercase font-size-14">Times relacionados</h5>
              ...
              <div class="col-lg-6">
                <h5 class="text-uppercase font-size-14">Sistema</h5>
